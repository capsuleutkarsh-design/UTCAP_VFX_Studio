...
; We install the entire shared library folder EXCEPT the server components
Source: "{#SourceDistDir}\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs; Excludes: "UT_Server.exe,ut_server\*,ut_server"
